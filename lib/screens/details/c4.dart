...
import 'package:video_player1/lessons/lesson4.dart';
              ...
              children: [
                ...
                Column(
                  children: [
                    ...
                    const Text(
                      "Learn the building blocks of the web - HTML and CSS. Structure web pages, add content and images, and apply styling to create your own web designs.",
                      style: TextStyle(
                        color: Colors.grey,
                        fontWeight: FontWeight.w500,
                        fontSize: 16,
  ...
  Widget build(BuildContext context) {
    return Expanded(
      child: ListView.separated(
        ...
        itemCount: c4.length,
        itemBuilder: (_, index) {
          return LessonCard4(lesson: c4[index]);
        },
      ),
    );
  }
