...
import 'package:video_player1/lessons/lesson3.dart';
              ...
              children: [
                ...
                Column(
                  children: [
                    ...
                    const Text(
                      "Dive into the world of Scratch Jr, a block-based programming language. Create interactive stories, animations, and games by snapping together visual blocks",
                      style: TextStyle(
                        color: Colors.grey,
                        fontWeight: FontWeight.w500,
                        fontSize: 16,
  ...
  Widget build(BuildContext context) {
    return Expanded(
      child: ListView.separated(
        ...
        itemCount: c3.length,
        itemBuilder: (_, index) {
          return LessonCard3(lesson: c3[index]);
        },
      ),
    );
  }
